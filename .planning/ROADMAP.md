...
- [x] 01-01-PLAN.md — Tracer: kokoro_tts provider + one-time deps/model download + offline synthesis smoke (Wave 1)
- [x] 01-02-PLAN.md — Selector no-silent-downgrade fix + documented ElevenLabs→Kokoro→Piper precedence (Wave 2)
- [x] 01-03-PLAN.md — Multilingual 54-voice/8-language breadth + `.agents/skills/kokoro` engine bridge (Wave 2)
...
|-------|----------------|--------|-----------|
| 1. Local TTS (Kokoro) | 3/3 | In Progress|  |
